...
export class DurationTermContext extends ParserRuleContext {
  ...
  public durationTermTail_list(): DurationTermTailContext[] {
    return this.getTypedRuleContexts(DurationTermTailContext) as DurationTermTailContext[];
  }

  public durationTermTail(i: number): DurationTermTailContext {
    return this.getTypedRuleContext(DurationTermTailContext, i) as DurationTermTailContext;
  }
